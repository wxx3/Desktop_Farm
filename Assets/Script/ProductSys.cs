...
public class ProductSys : SystemBase
{
    ...
    {
        ShoppingSys shoppingSys = m_Luncher.GetSystem<ShoppingSys>();
        shoppingSys.AddCoin(VarHelper.GetInt(entity.m_Props[PropId.price])); 
